...
Este é um projeto simples utilizando React e Vite, uma ferramenta de build rápida e moderna para desenvolvimento front-end. Sua finalidade é exibir para o usuário uma lista de links definida por um administrador, que também pode editá-los diretamente no site quando estiver com seu acesso autenticado.
...
1. Clone o repositório e acesse o diretório:
   ```bash
   git clone https://github.com/otaciliow/linksapp.git
   cd linksapp
...
- Firebase: Banco de Dados do projeto.
